...
public class Quiz extends JFrame implements ActionListener{
    ...
    String qa[][]= new String[10][2];
     ...
     Quiz(String username){
        ...
        ImageIcon il = new ImageIcon(ClassLoader.getSystemResource("quizpro/Icons/quiz.jpg"));
        ...
        qno.setBounds(100,450,700,30);
        add(qno);
       
        question= new JLabel("What is your Project name");
        ...
        opt1 = new JRadioButton("Quiz Project");
        opt1.setBounds(170,520,700,30);
        opt1.setFont(new Font("Dialog", Font.PLAIN,20));
        opt1.setBackground(Color.WHITE);
        add(opt1);
        
        opt2 = new JRadioButton("Quiz Project");
        opt2.setBounds(170,560,700,30);
        opt2.setFont(new Font("Dialog", Font.PLAIN,20));
        opt2.setBackground(Color.WHITE);
        add(opt2);
       
        opt3 = new JRadioButton("Quiz Project");
        opt3.setBounds(170,600,700,30);
        opt3.setFont(new Font("Dialog", Font.PLAIN,20));
        opt3.setBackground(Color.WHITE);
        add(opt3);
       
        opt4 = new JRadioButton("Quiz Project");
